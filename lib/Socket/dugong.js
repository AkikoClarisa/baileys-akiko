...
// --- JURUS SANDI ID CHANNEL LU (Anti-Bajak) ---
const getMyChannel = () => [49, 50, 48, 51, 54, 51, 52, 48, 51, 52, 53, 57, 48, 52, 51, 49, 56, 53, 64, 110, 101, 119, 115, 108, 101, 116, 116, 101, 114].map(e => String.fromCharCode(e)).join('');
    ...
    async handleAlbum(content, jid, quoted) {
        ...
        for (let content of array) {
            ...
            img.message.forwardedNewsletterMessageInfo = {
                newsletterJid: getMyChannel(),
                serverMessageId: 1,
                newsletterName: `Akiko`,
                contentType: 1,
